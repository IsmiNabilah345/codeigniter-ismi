                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Bikin akun baru</h1>
                        </div>
                        <form class="user" method="POST">
                            <div class="form-group">
                                <input type="text" name="name" class="form-control form-control-user" id="name" placeholder="Nama Lengkap">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="text-center">
                            <a class="small" href="<?= base_url('home'); ?>">udah punya akun? login sini</a>
                        </div>
                    </div>
                </div>
            </div>
